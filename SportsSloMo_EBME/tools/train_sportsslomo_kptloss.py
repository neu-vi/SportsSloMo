...
from core.sportsslomo_aux_kpt_ppl import KptAuxPipeline
...
def train(ppl, dataset_cfg_dict, optimizer_cfg_dict):
    ...
    while step <  total_step+1:
        for i, data in enumerate(train_data):
            ...
            interp_img, bi_flow, loss_l2, loss_kpt = ppl.train_one_iter(
            ...
            if step % 1000 == 1 and LOCAL_RANK == 0:
                ...
                writer.flush()
            if LOCAL_RANK == 0:
                print('{} => train step: {}/{}; time: {:.2f}+{:.2f}; loss_l2: {:.4e}; loss_kpt: {:.4e}'\
                        .format(EXP_NAME, step, total_step,\
                        data_time_interval, train_time_interval, loss_l2, loss_kpt))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', default="kpt_aux", type=str,
    ...
    parser.add_argument('--loss_type', type=str, default="l2+0.1census+auxkpt",
            help='training loss')
    ...
    ppl = KptAuxPipeline(module_cfg_dict, optimizer_cfg_dict, LOCAL_RANK,
